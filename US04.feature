Feature: US04 - Enlaces Directos a Redes Sociales de la aplicación
    ...
    Scenario: Acceso a las redes sociales de la plataforma.
        ...
        When haga click en uno de los logos de los botones como: [Outlook], [Facebook], [X] o [Instagram],
        ...
        | Outlook                                           | Usuario es redireccionado a la página de Celebra de la red social Outlook    |
